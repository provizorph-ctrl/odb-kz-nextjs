    ...
    <section className="py-3 sm:py-4">
      <div className="flex items-center justify-between mb-3 sm:mb-5 gap-2 min-w-0">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <h2 className="text-base sm:text-2xl font-bold text-foreground font-[family-name:var(--font-heading)] truncate">{t("galleryTitle")}</h2>
        </div>
        <a href="#" className="text-xs sm:text-sm text-primary hover:text-primary/80 font-medium transition-colors flex items-center gap-1 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary shrink-0">
          {t("allPhotos")}
      ...
      <div className="flex gap-1.5 sm:gap-2 mb-3 sm:mb-5 overflow-x-auto pb-1 scrollbar-hide" role="tablist" aria-label="Gallery categories">
        {categories.map((cat) => (
          <button
            ...
            className="px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium whitespace-nowrap transition-all duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary touch-manipulation min-h-[40px]"
            style={{
